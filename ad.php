...
<head>
    ...
    <title>COE Tools - Active Directory</title>
...
<body>
    ...
    <?php include "menu.php"; navbar("network"); ?>

    <main role="main" class="container">
        <div class="jumbotron cdg">
            <center>
                <iframe src="https://tools.engr.oregonstate.edu/coetools/lablogs/ADcontainers.php" onload="$('#preloader').fadeOut();" id="labiframe"></iframe>
            </center>
        </div>
    </main>
