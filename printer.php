...
<head>
    ...
    <title>COE Tools - Printer Status Old</title>
...
<body>
    ...
    <?php include "menu.php"; navbar("printer"); ?>

    <main role="main" class="container">
        <div class="jumbotron buttonx">
            <center>
                <iframe src="https://secure.engr.oregonstate.edu/coetools/printer/PrinterStatus.php" onload="$('#preloader').fadeOut();" id="printeriframe"></iframe>
            </center>
