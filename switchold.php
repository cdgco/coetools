...
<head>
    ...
    <title>COE Tools - Switch Tool Old</title>
...
<body>
    ...
    <main role="main" class="container">
        <div class="jumbotron cdg">
            <center>
                <iframe src="https://tools.engr.oregonstate.edu/coetools/switch.old/index.php" onload="$('#preloader').fadeOut();" id="labiframe"></iframe>
            </center>
        </div>
    </main>
