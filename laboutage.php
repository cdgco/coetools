...
<meta charset="utf-8">
    ...
    <title>COE Tools - Outage Status</title>
...
<body>
    ...
    <main role="main" class="container">
        <div class="jumbotron cdg">
            <center>
                <iframe src="https://tools.engr.oregonstate.edu/coetools/lablogs/outage.php?grp=Outage" onload="$('#preloader').fadeOut();" id="labiframe"></iframe>
            </center>
        </div>
    </main>
