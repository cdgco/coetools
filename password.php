...
<head>
    ...
    <title>COE Tools - Password Manager</title>
...
<body>
    ...
    <?php include "menu.php"; navbar("other"); ?>

    <div id="iframeDiv">
        <iframe src="https://order.engr.oregonstate.edu/teampasswordmanager" onload="$('#preloader').fadeOut();" id="fulliframe"></iframe>
    </div>
