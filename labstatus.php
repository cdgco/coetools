...
<head>
    ...
    <title>COE Tools - Lab Status</title>
...
<body>
    ...
    <main role="main" class="container">
        <div class="jumbotron buttonx">
            <center>
                <iframe src="https://tools.engr.oregonstate.edu/coetools/lablogs/labstatus.php" onload="$('#preloader').fadeOut();" id="buttoniframe"></iframe>
            </center>
