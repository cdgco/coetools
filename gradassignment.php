...
<head>
    ...
    <title>COE Tools - Grad Desk Assignments</title>
...
<body>
    ...
    <?php include "menu.php"; navbar("grad"); ?>

    <div id="iframeDiv">
        <iframe src="https://tools.engr.oregonstate.edu/desktools/cce-grads/" onload="$('#preloader').fadeOut();" id="fulliframe"></iframe>
    </div>
