...
<head>
    ...
    <title>COE Tools - License Server Status</title>
...
<body>
    ...
    <?php include "menu.php"; navbar("license"); ?>


    <div id="iframeDiv">
        <iframe src="https://order.engr.oregonstate.edu/phplicensewatcher/" onload="$('#preloader').fadeOut();" id="fulliframe"></iframe>
    </div>
